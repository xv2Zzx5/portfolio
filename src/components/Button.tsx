...
const classesMap = {
    primary: `bg-primary-200 text-dark-200 active:scale-105 hover:-translate-y-0.5 transition-all px-1 py-0.75`,
    white: `bg-white text-dark-200 active:scale-105 hover:-translate-y-0.5 transition-all px-1 py-0.75 `,
    ...
    return (
        <Component
            ...
            className={cn(
                classes,
                className,
                "rounded-lg flex justify-center items-center gap-3  outline-none  cursor-pointer"
            )}
        >
            {render}
            {Icon && <span>{Icon} </span>}
